...
{
    static class URPRendererUtility
    {
        /// <summary>
        /// 현재 설정된 렌더 파이프라인 에셋을 가져옵니다.
        /// </summary>
        /// <returns>설정된 렌더 파이프라인 에셋을 반환합니다. 에셋이 없는 경우 null을 반환합니다.</returns>
        internal static RenderPipelineAsset GetRenderPipelineAsset()
        {
        ...
        internal static ScriptableRendererData[] GetScriptableRendererData()
        {
        ...
        internal static UniversalRendererData GetUniversalRendererData(int rendererListIndex = 0)
        {
        ...
        internal static bool IsPostProcessEnabled(UniversalRendererData universalRendererData, ref RenderingData renderingData)
        {
